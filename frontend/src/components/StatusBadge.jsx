...
const StatusBadge = ({
  ...
  return (
    <div className={`inline-flex items-center ${sizeClasses[size]} rounded-full font-medium
     ...
     ease-out hoever:scale-105 hover:shadow-sm group relative overflow-hidden`}>
        <div className={`absolute inset-0 bg-linear-r ${config.gradient} opacity-0 group-hover:opacity-5 transition-opacity duration-300`}></div>
