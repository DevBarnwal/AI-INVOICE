...
// file handling helpers: kind = "logo" | "stamp" | "signature"
  ...
  // you can remove the previewfile by this function if you want to change itor remove it
                            ...
                            <div className={businessProfileStyles.taxContainer}>
                                ...
                                <div className='flex items-center gap-3'>
                                    <input type="number" min={0} max={100} step='0.1' className={businessProfileStyles.taxInput}
                                        value={meta.defaultTaxPercent ?? 18} onChange={(e) => 
                                            updateMeta(
                                                "defaultTaxPercent",
