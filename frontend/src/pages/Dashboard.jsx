...
const Dashboard = () => {
  ...
  // KPIs computation with percentages ie (convert each invoices to inr before summarizing)
  const kpis = useMemo(() => {
  ...
  //recent invoices created at date in DB  
            ...
            <div className={dashboardStyles.quickStatsCard}>
              ...
              <div className='space-y-3'>
                ...
                <div className={dashboardStyles.quickStatsRow}>
                      ...
                      <span className={dashboardStyles.quickStatsValue}>
                        {currencyFmt(kpis.totalInvoices > 0
